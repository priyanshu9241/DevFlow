...
const MobileNav = () => {
  return (
    <Sheet>
      ...
      <SheetContent side="left" className="background-light900_dark200 text-dark300_light900 border-none">
        {/* Logo */}
        ...
        <div>
          ...
          <SignedOut>
            <div className="flex flex-col gap-3">
              <SheetClose asChild>
                {/* Log in */}
                <Link href="/sign-in"><Button className="small-medium btn-secondary min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none"><span className="primary-text-gradient">Log In</span></Button></Link>
              </SheetClose>

              {/* Sign up */}
              <SheetClose asChild>
                <Link href="/sign-up"><Button className="small-medium light-border-2 btn-tertiary text-dark400_light900 min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none">Sign Up</Button></Link>
              </SheetClose>
            </div>
          </SignedOut>
        </div>
